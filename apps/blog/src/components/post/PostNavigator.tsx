        ...
        <div className="w-full min-w-0">
          {prevPost ? (
            <Link
              ...
              className="group flex flex-col justify-center h-full p-3 md:p-4 rounded-xl border border-[var(--border)] bg-[var(--surface)] hover:bg-[var(--card-bg)] hover:border-[var(--accent)] transition-all duration-200 shadow-sm hover:shadow-md"
            >
        ...
        <div className="w-full min-w-0">
          {nextPost ? (
            <Link
              ...
              className="group flex flex-col justify-center items-end h-full p-3 md:p-4 rounded-xl border border-[var(--border)] bg-[var(--surface)] hover:bg-[var(--card-bg)] hover:border-[var(--accent)] transition-all duration-200 shadow-sm hover:shadow-md text-right"
            >
              <div className="flex items-center gap-1 md:gap-2 text-xs md:text-sm text-[var(--muted)] font-medium mb-1 md:mb-2 group-hover:text-[var(--accent)] transition-colors">
                <span>다음</span>
